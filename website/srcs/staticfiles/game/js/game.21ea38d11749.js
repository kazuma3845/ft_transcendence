...
async function fetchAvailableSessions() {
    try {
        ...
        const response = await fetch('http://127.0.0.1:8000/api/gamesessions/available_sessions/');
        ...
        sessions.forEach(session => {
            ...
            link.href = `http://127.0.0.1:8000/api/game/sessions/${session.id}/join_game/`;

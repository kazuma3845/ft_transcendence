...
async function loadFriends() {
  try {
    ...
    friendRequests.forEach(async (request) => {
      ...
      // Créer un conteneur pour la demande d'ami
      const requestContainer = document.createElement("div");
      requestContainer.className = "friend-request d-flex align-items-center justify-content-between mb-3";
      ...
      // Ajouter le lien au conteneur de la demande d'ami
      requestContainer.appendChild(requestLink);

      // Créer le badge d'acceptation (avec un "v")
      const acceptBadge = document.createElement("span");
      acceptBadge.className = "badge rounded-pill bg-success text-white ms-2";
      ...
      // Créer le badge de refus (avec un "x")
      const rejectBadge = document.createElement("span");
      rejectBadge.className = "badge rounded-pill bg-danger text-white me-2";
      ...
      requestContainer.appendChild(rejectBadge); // À gauche
      requestContainer.appendChild(acceptBadge); // À droite

  ...
  try {
    ...
    friendRequests.forEach(async (request) => {
      ...
      requestContainer.className =
        "friend-request position-relative d-inline-block"; // Position relative pour positionner les badges sur l'avatar
      ...
      acceptBadge.className =
        "friend-request-badge badge rounded-pill bg-success text-white position-absolute top-0 end-0 m-1";
      ...
      rejectBadge.className =
        "friend-request-badge badge rounded-pill bg-danger text-white position-absolute top-0 start-0 m-1";

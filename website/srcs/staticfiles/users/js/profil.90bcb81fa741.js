...
async function loadFriends() {
  try {
    ...
    friendRequests.forEach(async (request) => {
      ...
      requestContainer.className = "friend-request";
      ...
      // Ajouter les boutons au conteneur de la demande d'ami
      requestContainer.appendChild(acceptButton);
      requestContainer.appendChild(rejectButton);

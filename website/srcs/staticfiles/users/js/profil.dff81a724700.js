...
async function loadFriends() {
  try {
    ...
    currentUserInfo.friends.forEach(async (friend) => {
      ...
      friendAvatar.setAttribute("data-bs-toggle", "tooltip");
      friendAvatar.setAttribute("data-bs-placement", "bottom");
      friendAvatar.setAttribute("data-bs-title", friend.username);

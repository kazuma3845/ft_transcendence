export default class Pong {
    ...
    async sendDataForID() {
        ...
        try {
            const response = await fetch(`http://10.18.203.86:8000/api/game/sessions/${sessionId}/start_single/`, {
                method: 'POST',
                credentials: 'include',
                headers: {
    ...
    sendDataToScore() {
        ...
        fetch(`http://10.18.203.86:8000/api/game/sessions/${this.id}/update_score/`, {
            method: 'POST',
            credentials: 'include',
            headers: {
                'Content-Type': 'application/json',
